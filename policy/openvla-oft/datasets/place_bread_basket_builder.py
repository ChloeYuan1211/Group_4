...
class aloha_place_bread_basket(MultiThreadedDatasetBuilder):
    ...
    def _split_paths(self):
        train_files = glob.glob(
            "/home/qdhe/workspace/dda4210/project/dataset/data_preprocessed/place_bread_basket/aloha-agilex_clean_50/train/*.hdf5"
        )
        val_files = glob.glob(
            "/home/qdhe/workspace/dda4210/project/dataset/data_preprocessed/place_bread_basket/aloha-agilex_clean_50/val/*.hdf5"
        )
...
if __name__ == "__main__":
    ...
    builder = aloha_place_bread_basket(data_dir=tfds_data_dir)
